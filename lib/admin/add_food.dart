...
class _AddFoodState extends State<AddFood> {
  final List<String> fooditems = ['Ice-cream', 'MilkTea', 'Taco', 'Chicken'];
  String? value;
    ...
    if (selectedImage != null &&
      ...
      await DatabaseMethods().addFoodItem(addItem, value!).then((value) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            backgroundColor: const Color.fromARGB(255, 40, 213, 78),
            content: const Text(
        ...
        // Reload the page (assuming you're in a stateful widget)
        Navigator.pop(context); // Pop the current page
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) =>
                  AddFood()), // Replace YourPage with the current page widget
        );
      });
    } else {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
